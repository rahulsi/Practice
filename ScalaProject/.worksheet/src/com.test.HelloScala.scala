...
object HelloScala {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(114); 
  ...
  expand(3, List("rahul", "singh"));System.out.println("""res26: List[String] = """ + $show(res$26));$skip(788); 
  ...
  findSumFunc(100, 3, 5);System.out.println("""res41: Int = """ + $show(res$41));$skip(322); 
  ...
  };System.out.println("""CountWays: (sizex: Int, sizey: Int)Int""");$skip(21); val res$42 = 
	
		CountWays(4, 4);;System.out.println("""res42: Int = """ + $show(res$42))}
